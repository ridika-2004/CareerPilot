...
urlpatterns = [
    ...
    path('applications/<int:pk>/', JobApplicationView.as_view(), name='tracker-application-detail'),
    path('todos/', TodoItemView.as_view(), name='tracker-todos'),
    path('todos/<int:pk>/', TodoItemView.as_view(), name='tracker-todo-detail'),
    ...
    path('goals/<int:pk>/', CustomGoalView.as_view(), name='tracker-custom-goal-detail'),
